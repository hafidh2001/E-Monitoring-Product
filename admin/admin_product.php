    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- button tambah Data -->
          <a href="cetak_product.php" target="_blank" class="btn btn-success mb-4" onClick="return confirm('Apakah anda ingin mencetak data ini ?');"><i class="fas fa-plus-square mr-2"></i>Cetak Data </a>
