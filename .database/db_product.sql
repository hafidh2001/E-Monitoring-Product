...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2021 at 04:58 PM
...
('f8a871b4-f51d-4c24-af6c-9c69e9c13f78', 'WEBSITE', 'MONITORING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'websitemonitoring100@gmail.com', '$2y$10$gR0RR3eIrp4mxpb.VBfG1.WkgkpIKOr.wHZHv5EYLxo/I3BG27wJa', '2021-05-29 20:34:25');
...
(13, '42702a98-9ca6-4ae4-9b72-b16a47b0e46b', 'SATISFYING');
...
--
ALTER TABLE `tb_product_members`
  MODIFY `id_product_members` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=186;

--
-- AUTO_INCREMENT for table `tb_product_thumbnails`
--
ALTER TABLE `tb_product_thumbnails`
  MODIFY `id_product_thumbnails` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
ALTER TABLE `tb_survey`
  MODIFY `id_survey` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
